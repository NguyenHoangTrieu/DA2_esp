    ...
    <div class="card">
      ...
      <div class="form-row">
        ...
        <input class="form-input" id="fotaLanUrl" type="text"
            placeholder="http://192.168.1.100:8080/api/v1/TOKEN/firmware?title=DA2_esp_LAN&version=${CURRENT_FW_VERSION}"
    ...
    <div class="card" style="margin-top:16px">
      ...
      <div class="form-row">
        ...
        <input class="form-input" id="fotaWanUrl" type="text"
            placeholder="http://192.168.1.100:8080/api/v1/TOKEN/firmware?title=DA2_esp&version=${CURRENT_FW_VERSION}"
