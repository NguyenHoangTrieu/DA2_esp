...
export const FUNCTION_GROUPS = {
  ...
  ZIGBEE: [
    { emoji: '🔄', title: 'Lifecycle', functions: ['MODULE_HW_RESET','MODULE_SW_RESET','MODULE_FACTORY_RESET','MODULE_GET_INFO','MODULE_ENTER_HEX_MODE'] },
    { emoji: '🌐', title: 'Network Management', functions: ['MODULE_START_NETWORK','MODULE_STOP_NETWORK','MODULE_GET_NET_STATUS','MODULE_SET_CHANNEL','MODULE_SET_PANID','MODULE_SET_TX_POWER','MODULE_SET_PERMIT_JOIN'] },
    { emoji: '🔍', title: 'Node Discovery', functions: ['MODULE_NODE_JOIN_NOTIFY','MODULE_NODE_LEAVE_NOTIFY','MODULE_NODE_ANNOUNCE_NOTIFY','MODULE_QUERY_SHORT_ADDR','MODULE_QUERY_NODE_PORT_INFO','MODULE_DELETE_NODE'] },
