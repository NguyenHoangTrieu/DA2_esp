#ifndef ESP_MODEM_USB_DCE_COMMON_COMMANDS_H_
 ...
 *
 * @param[in] dce     Modem DCE object
 * @param[in] param   esp_modem_usb_flow_ctrl_t casted to (void*): flow control mode
 * @param[out] result None
 *
 * @return esp_err_t
 *      - ESP_OK on success
 ...
 *
 * @param[in] dce     Modem DCE object
 * @param[in] param   esp_modem_usb_dce_pdp_ctx_t type defining PDP context
 * @param[out] result None
 *
 * @return esp_err_t
 *      - ESP_OK on success
...
/**
 * @brief Signal strength structure used as a result to esp_modem_usb_dce_get_signal_quality() API
 */
typedef struct esp_modem_usb_dce_csq_ctx_s {
    int rssi;             //!< Signal strength indication
    int ber;              //!< Channel bit error rate
} esp_modem_usb_dce_csq_ctx_t;
 ...
 * @param[in] dce     Modem DCE object
 * @param[in] param   None
 * @param[out] result esp_modem_usb_dce_csq_ctx_t type returning rssi and ber values
 *
 * @return esp_err_t
 *      - ESP_OK on success
 *      - ESP_FAIL on error
...
/**
 * @brief Voltage status structure used as a result to esp_modem_usb_dce_get_battery_status() API
 */
typedef struct esp_modem_usb_dce_cbc_ctx_s {
 ...
 * @param[in] dce     Modem DCE object
 * @param[in] param   None
 * @param[out] result esp_modem_usb_dce_cbc_ctx_t type returning battery status and other fields if available
 *
 * @return esp_err_t
 *      - ESP_OK on success
 *      - ESP_FAIL on error
...
#endif // ESP_MODEM_USB_DCE_COMMON_COMMANDS_H_