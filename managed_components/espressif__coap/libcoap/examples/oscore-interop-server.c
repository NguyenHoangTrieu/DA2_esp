 ...
 *
 * Copyright (C) 2022-2025 Olaf Bergmann <bergmann@tzi.org> and others
 *
...
#define INDEX "This is a OSCORE test server made with libcoap " \
  ...
  "Copyright (C) 2022-2025 Olaf Bergmann <bergmann@tzi.org> " \
  "and others\n\n"
...
usage(const char *program, const char *version) {
  ...
  fprintf(stderr, "%s v%s -- OSCORE interop implementation\n"
          "(c) 2022-2025 Olaf Bergmann <bergmann@tzi.org> and others\n\n"
          "Build: %s\n"
          "%s\n"
